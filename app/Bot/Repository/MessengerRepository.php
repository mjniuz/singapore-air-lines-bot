                    ...
                    "payload"   => [
                        ...
                        "flight_info"   => [
                            [
                                ...
                                "flight_schedule" => [
                                    "boarding_time"     => date(DATE_ISO8601, strtotime($message['flight_schedule']['boarding_time'])),
                                    "departure_time"    => date(DATE_ISO8601, strtotime($message['flight_schedule']['departure_time'])),
                                    "arrival_time"      => date(DATE_ISO8601, strtotime($message['flight_schedule']['arrival_time']))
                                ]
                            ]
                        ]
                    ]
